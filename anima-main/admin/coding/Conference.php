...
$statement = $db->prepare("SELECT * FROM conferencecontest");
$statement->execute();
...
if (isset($_POST['update'])) {
	...
	$sql = "UPDATE conferencecontest SET 
								...
								<table>
									<thead>
										<tr class="row100 head">
											<th class="cell100 column1">BLOCK</th>
											<th class="cell100 column2">A BLOCK</th>
											<th class="cell100 column3">B BLOCK</th>
											<th class="cell100 column4">C BLOCK</th>
								...
								<table>
									<tbody>
										...
										<tr class="row100 body">
											<td class="cell100 column1">PROGRAM</td>
